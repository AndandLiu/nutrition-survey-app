...
public class ResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        presentCitySavings();
        improve_diet = (Button) findViewById(R.id.improve_diet);
        improve_diet.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                onImproveSelectionNext();
            }
        });
    }
    ...
    public void onImproveSelectionNext() {
        Intent intent = new Intent(this, ImprovedDietActivity.class);
