...
public class WelcomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        trackCO2e = (Button) findViewById(R.id.trackCo2ForTodayBtn);
        trackCO2e.setText(Html.fromHtml("Track CO<small><sub>2</sub></small>e for Today"));
    ...
    public void trackCo2ForToday(View view) {
        Intent intent = FoodSelectionActivity.makeIntent(WelcomeActivity.this);
